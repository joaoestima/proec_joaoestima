...
output_folder = r'C:/Users/João Estima/Documents/PROEC/proec_joaoestima/coletor_paragrafos/data/merged_datav2'
...
def main():         # Iterate over CSV files in the folder
